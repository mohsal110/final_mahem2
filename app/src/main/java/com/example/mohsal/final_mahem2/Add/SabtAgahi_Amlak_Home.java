...
public class SabtAgahi_Amlak_Home extends AppCompatActivity {
    ...
    EditText Group, Title, Amlak_type, meter, Type, AgahiDahande_type, Gheimat, call, Tozihat, location, PhoneNum, Email, rahn, ejareh;
        ...
        map_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                send.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        SabtAgaghi_Amlak_Home__SEND(Group.getText().toString(), Title.getText().toString(), Amlak_type.getText().toString(), meter.getText().toString(), Type.getText().toString(),
    ...
    ///network
    void SabtAgaghi_Amlak_Home__SEND(String Group,String Title,String Amlak_type,String meter,String Type
